...
function Login() {
  ...
  return (
    <div className="container mx-auto grid grid-cols-2" style={{marginTop: '120px'}}>
      <div className="col-start-2 shadow-xl p-[40px]">
